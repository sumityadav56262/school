<nav class="c_nav d-flex sticky-top justify-content-between align-items-center px-4 py-3 shadow-sm">
    ...
    <div class="dropdown">
        <button class="btn btn-outline-light d-flex align-items-center border-0" type="button" id="userMenuButton"
        ...
        <ul class="dropdown-menu dropdown-menu-end mt-2" aria-labelledby="userMenuButton">
                ...
                @else
                    <li>
                        <span class="dropdown-item text-success d-flex align-items-center">
                            ...
                            {{ session('subscription_days_left') }}
                            day{{ session('subscription_days_left') == 1 ? '' : 's' }} left
                        </span>
                    </li>
                @endif
                <li>
            ...
            <li>
                <form action="{{ route('logout') }}" method="POST" class="d-inline">
                    @csrf
                    <button type="submit"
                        class="dropdown-item text-danger d-flex align-items-center border-0 bg-transparent">
